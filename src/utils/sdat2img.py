...
def run_sdat2img(transfer_list_file, new_dat_file, output_image_file):
    ...
    try:
        ...
        logging.error("sdat2img: invalid transfer list file")
        return False
    except IndexError:
        logging.error("sdat2img: invalid format")
        return False
        ...
        for line in trans_list:
            ...
            if cmd == "new":
                ...
                try:
                    ...
                    logging.error(f"sdat2img: error parsing line: {line} ({e})")
                    return False
